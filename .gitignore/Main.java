...
static int NUMERO_MASSIMO_PROGETTI=16;
...
int main(void){
	...
	String *progetti[NUMERO_MASSIMO_PROGETTI];
	...
	boolean vettore_progetti_valido = false;
	//! indicatore di validità del contenuto del vettore attivita
	boolean vettore_attivita_valido = false;
					 ...
					 switch (comando)
						   {
							...
							case 7:		// aggiunta di nuova attivita' al progetto
										...
										break;
							case 8:		// aggiornamento percentuale di svolgimento attivita'
										...
										break;
							case 9:		// aggiornamento data di scadenza attivita'
										if (!vettore_attivita_valido)
										  {
											cout << "Visualizzare elenco attivita" << endl;
											break;
										...
										else
											{
												...
												if (progetto->aggiornaAttivita(descrizione_attivita, data))
												  cout << "Data di scadenza dell'attivita' del progetto aggiornata" << endl;
													...
													cout << "Errore aggiornamento data di scadenza dell'attivita' del progetto" << endl;
											}
										break;
